...
public record ItinerariesCreateResponse(UUID tripId, List<ItineraryCreateResponse> itineraries) {
                    ...
                    i ->
                        new ItineraryCreateResponse(
                            ...
                            i.getItineraryDetails().getValues().stream()
                                .map(
                                    id ->
                                        new ItineraryCreateResponse.ItineraryCreateDetailResponse(
                                            id.getId(),
    ...
    public record ItineraryCreateResponse(
        UUID id, String name, LocalDate date,
