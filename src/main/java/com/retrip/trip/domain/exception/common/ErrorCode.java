...
public enum ErrorCode {
    ...
    NOT_PARTICIPANT(BAD_REQUEST, "Trip-015", "여행 참여자가 아닙니다."),
    INVITATION_EXPIRED(BAD_REQUEST, "Trip-016", "초대가 만료되었습니다."),
    TRIP_NOT_RECRUITING(BAD_REQUEST, "Trip-017", "여행이 모집중이 아닙니다."),
    TRIP_PARTICIPANTS_IS_FULL(BAD_REQUEST, "Trip-018", "여행 참여자가 가득 찼습니다."),
    INVITATION_REJECT_NOT_ALLOWED(BAD_REQUEST, "Trip-019", "초대 거절이 불가능한 상태입니다.");
