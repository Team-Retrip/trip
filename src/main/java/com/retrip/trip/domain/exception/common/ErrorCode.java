...
public enum ErrorCode {
    ...
    TRIP_MEMBER_BANNED_CANNOT_APPLY(BAD_REQUEST, "TRIP-007", "강퇴된 사용자는 해당 여행에 참가 신청할 수 없습니다."),
    ...
    TRIP_CONFIRMATION_PERIOD_OUT_OF_RANGE(BAD_REQUEST, "TRIP-019", "요청한 여행 확정 기간은 여행의 전체 기간 범위를 벗어날 수 없습니다."),
    TRIP_CONFIRMATION_START_AFTER_END(BAD_REQUEST, "TRIP-020", "요청한 여행 확정 시작일은 종료일보다 이후일 수 없습니다."),
    NOT_FOUND_PARTICIPANTS(BAD_REQUEST, "TRIP-021", "참가자가 존재하지 않습니다."),
    NOT_TRIP_READY_STATUS(BAD_REQUEST, "TRIP-022", "여행 준비 상태가 아닙니다."),
