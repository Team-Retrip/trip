...
public enum ErrorCode {
    ...
    TRIP_MEMBER_BANNED_CANNOT_APPLY(
            HttpStatus.BAD_REQUEST, "TRIP-007", "강퇴된 사용자는 해당 여행에 참가 신청할 수 없습니다."),
    ...
    PARTICIPANT_FULL(BAD_REQUEST, "Trip-011", "여행 최대 인원수보다 참가자가 많을 수 없습니다."),
